...
void Instructions()
{
    ...
    cout << "Инструкция:\n\n";
    cout << "1. Первая координата считается по вертикали," << endl;
    cout << " вторая по горизонтали." << endl;
    cout << "2. Игрок #1 ходит крестиками \'X\' " << endl;
    cout << "игрок #2 ходит \'0\' по очереди." << endl;
    cout << "3. Побеждает тот, у кого выставленные им символы" << endl;
    cout << " трижды пересекаются либо по горизонтали," << endl;
    cout << " либо по вертикали, либо по диагонали." << endl;
    cout << "4. Если тройной комбинации нет, получается ничья!\n" << endl;
}
